...
from simparts.features.magnet import MagnetSpec
from simparts.features.rotor import RotorSpec, build_rotor_and_magnets
from simparts.features.stator import StatorSpec, build_stator
from simparts.features.winding import WindingSpec
