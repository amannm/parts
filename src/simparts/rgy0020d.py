...
from simparts.features.package import build_body, export_step, union_solids
from simparts.features.pin import (
    GroundedLeadSpec,
    LeadDims,
    LeadDimple,
    LeadLayout,
...
from simparts.features.thermal_pad import thermal_pad_solids_for_params
